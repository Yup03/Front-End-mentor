...
const Modal = ({ setShowModal, showModal }) => {
  return (
    <>
      {showModal && (
        <div className="hidden invisible pointer-events-none md:block md:visible md:pointer-events-auto absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 p-16 md:z-50">
          <button
